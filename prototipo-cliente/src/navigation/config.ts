...
export const paths = {
  ...
  cursos: '/ux/cursos',
  cursosNuevo: '/ux/cursos/nuevo',
  encuestas: '/ux/encuestas',
  encuestasNueva: '/ux/encuestas/nueva',
  encuestasEditar: (id: string) => `/ux/encuestas/${encodeURIComponent(id)}/editar`,
  nom035: '/ux/nom-035',
  nom035Guia: (id: string | number) => `/ux/nom-035/guias/${encodeURIComponent(String(id))}`,
  vacantes: '/ux/vacantes',
  roles: '/ux/roles',
  rolesNueva: '/ux/roles/nueva',
